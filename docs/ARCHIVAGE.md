...
>
> La liste des TR (`remplacements_tr`) n'est **pas** purgée : l'équipe de remplaçants persiste d'une année sur l'autre (elle est néanmoins photographiée dans l'archive).
