    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-700 via-primary-500 to-[#45b8a0]">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="card mb-8">
          ...
          {parStatut.titulaires !== undefined && (
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="p-6 bg-blue-50 rounded-lg border-2 border-blue-200">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-3xl font-bold text-blue-700">{parStatut.titulaires || 0}</span>
                  </div>
                </div>
                <div className="p-6 bg-green-50 rounded-lg border-2 border-green-200">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-gray-700">Stagiaires</span>
                    <span className="text-3xl font-bold text-green-700">{parStatut.stagiaires || 0}</span>
                  </div>
                </div>
                <div className="p-6 bg-red-50 rounded-lg border-2 border-red-200">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-gray-700">Contractuels</span>
                    <span className="text-3xl font-bold text-red-700">{parStatut.contractuels || 0}</span>
                  </div>
                </div>
              </div>
            </div>
