...
export default function EvaluationsPage() {
    ...
    return (
      <div>
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          />
          <StatPill
            value={selectedEcole ? ecoles.find(e => e.uai === selectedEcole)?.nomAffiche || ecoles.find(e => e.uai === selectedEcole)?.nom || 'École' : 'Circonscription'}
            label="Périmètre"
  ...
  // Graphique 2 : Évolution par école/niveau/matière/compétence
        ...
        <div className="card mb-8" id="section-graphique2">
          ...
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              {/* 3. Matière — filtrée selon le niveau */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Matière</label>
                <select
